...
@section('content')
  <div class="flex-container">
    <div class="columns m-t-10 m-b-0">
      <div class="column">
        <h1 class="title is-admin is-4">Update The Post</h1>
      </div>
    </div>
    <hr class="m-t-0">
      ...
      <div class="columns">
        <div class="column is-three-quarters-desktop is-three-quarters-tablet">
          ...
          <b-field  type="is-primary">
            <b-input type="text" name="title" value="{{$post->title}}" size="is-large" v-model="title">
            </b-input>
          </b-field>

          <slug-widget url="{{url('/')}}" subdirectory="blog" :title="title" @copied="slugCopied" @slug-changed="updateSlug"></slug-widget>
          <input type="hidden" v-model="slug" name="slug"  value="{{$post->slug}}"/>
          ...
          <b-field class="m-t-40" type="is-primary">
            <b-input type="textarea"
                placeholder="Write a short description..."  name="excerpt" value="{{$post->excerpt}}">
            </b-input>
          </b-field>

          <b-field class="m-t-40"  type="is-primary">
            <b-input type="textarea"
                placeholder="Compose your masterpiece..." rows="20" name="content" value="{{$post->content}}">
            </b-input>
          </b-field>

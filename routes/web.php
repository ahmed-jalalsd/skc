...
Route::prefix('manage')->group(function(){
  ...
  Route::resource('/roles', 'RoleController', ['except' => 'destroy']);
	...
	Route::get('/results/event/sex/judge-area/{eventId}/{groupId}/{classId}', 'ResultsController@chooseSex')->name('results.chooseSex'); // to show all classes inside a group for event for the judge

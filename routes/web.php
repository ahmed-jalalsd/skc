...
Route::prefix('manage')->group(function(){
  ...
  Route::resource('/roles', 'RoleController', ['except' => 'destroy']);
	...
	Route::get('/results/event/classes/judge-area/{eventId}', 'ResultsController@showClasses')->name('results.classes'); // to show all classes inside a group for event for the judge
	Route::get('/results/event/sex/judge-area/{eventId}/{classId}', 'ResultsController@chooseSex')->name('results.chooseSex'); // to show all classes inside a group for event for the judge
